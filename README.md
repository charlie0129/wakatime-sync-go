...
- Spring + Java is just too heavy. Consumes a ton of memory. The image size is huge. Using CPU even on idle. I just cannot tolerate that on my personal server. Just use Go, it's simple, efficient, and compiles to a single binary.
